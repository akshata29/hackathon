...
#   - which delegated permissions apply (scp claim, e.g. "portfolio.read")
#
# Reference:
...
def build_obo_http_client(
    ...
    Args:
        ...
        scope_name:      The OAuth2 scope to request (e.g. "portfolio.read").
    ...
    # Dev mode — static bearer + optional X-User-Id for RLS
    if fallback_bearer:
