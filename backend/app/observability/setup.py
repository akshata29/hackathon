...
def configure_observability() -> None:
    ...
    os.environ.setdefault("OTEL_SERVICE_NAME", "portfolio-advisor-backend")
...
def _configure_console_observability() -> None:
    ...
    try:
        ...
        if otlp_endpoint:
            ...
            logger.info("Console observability configured (no exporter — set OTEL_EXPORTER_OTLP_ENDPOINT to forward telemetry)")
